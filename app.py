...
model = pickle.load(open("sepsa05.pkl", "rb"))  ##loading model
...
def predict(): 
    ...
    row_df = pd.DataFrame([pd.Series([text1,text2,text3,text4,text5,text6,text7,text8,text9,text10,text11,text12,text13])])  ### Creating a dataframe using all the values
    print(row_df)
